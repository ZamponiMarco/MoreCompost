...
public class ExperienceDropSettingsInventoryHolder extends DropSettingsInventoryHolder {
	...
	protected void initializeInventory() {
		...
		ExperienceCompostDrop drop = (ExperienceCompostDrop) dropTable.get(dropId);
		...
		registerClickConsumer(12,
				getSettingItem(wrapper.skullFromValue(MINIMUM_HEAD), "minAmount", drop.getMinAmount()),
				getSettingConsumer(manager, section, "minAmount", drop.getMinAmount(),
						IntegerSettingInventoryHolder.class));
		registerClickConsumer(14,
				getSettingItem(wrapper.skullFromValue(MAXIMUM_HEAD), "maxAmount", drop.getMaxAmount()),
				getSettingConsumer(manager, section, "maxAmount", drop.getMaxAmount(),
						IntegerSettingInventoryHolder.class));
