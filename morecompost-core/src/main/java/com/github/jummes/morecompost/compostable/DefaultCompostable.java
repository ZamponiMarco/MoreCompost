...
public enum DefaultCompostable {
    ...
    WARPED_FUNGUS(.65), CRIMSON_ROOTS(.65), WARPED_ROOTS(.65), BAKED_POTATO(.85),
    BREAD(.85), COOKIE(.85), HAY_BLOCK(.85), BROWN_MUSHROOM_BLOCK(.85),
    RED_MUSHROOM_BLOCK(.85), NETHER_WART_BLOCK(.85), WARPED_WART_BLOCK(.85), CAKE(1),
    PUMPKIN_PIE(1);
