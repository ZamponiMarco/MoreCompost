...
public class ItemDropSettingsInventoryHolder extends DropSettingsInventoryHolder {
	...
	private static final String MATERIAL_HEAD = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWM5ZDZmMTE1Y2MwNzg0MTgzZGZjNzU4NDdmZGI0ZWRkYzI2ZGMxNzgyM2U2ZTA0YTZmNjU1MzUyYTExNzliIn19fQ=====";
	...
	public ItemDropSettingsInventoryHolder(String dropTableId, String dropId, InventoryHolder holder) {
	...
	protected void initializeInventory() {
		...
		ItemCompostDrop drop = (ItemCompostDrop) dropTable.get(dropId);
		...
		registerClickConsumer(14,
				getSettingItem(wrapper.skullFromValue(MATERIAL_HEAD), "material", drop.getItem().getType()),
				getSettingConsumer(manager, section, "material", drop.getMaxCount(),
